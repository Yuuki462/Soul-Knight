...
bool TitleScene::init() {
    ...
    BackgroundMusicId = AudioEngine::play2d("Audio/bgm_1Low.mp3", true, .5);
    AudioEngine::preload("Audio/fx_btn1.mp3");
    IsMusic = true;
    IsEffect = true;
...
void TitleScene::menuStartCallback(Ref* pSender) {
    ...
    BackgroundMusicId = AudioEngine::play2d("Audio/bgm_room.mp3", true, 0.5f);
    if (!IsMusic)
        AudioEngine::pause(BackgroundMusicId);
